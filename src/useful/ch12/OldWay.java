...
public class OldWay {
    ...
    public static void main(String[] args) {
        ...
        // 일단 출력 형식부터 문제임. 영어 요일과 월 이름이 섞여 있어서 사용자 화면에 그대로 쓸 수 없음

        // 2. Date 로 특정 날짜 만들기
        Date date = new Date(2025, 4, 12);
        System.out.println("설정한 날짜 : " + date);
        // 3925 년도로 결과가 확인 됨.
        // Date의 연도는 1900을 기준으로 세기 때문에 그래서 2025년을 만들려고 하면 125 를 넣어야 한다.
        ...
        System.out.println("------------------------------------");
        // Date 타입에 대안 1.1 에서
        Calendar cal = Calendar.getInstance(); // new Calendar() <-- 싱글톤 패턴 구현 되어 있어 메서로 호출 해야 함
        cal.set(2025, 4, 12); // 2025  5월 12일 설정 함
        System.out.println(cal.getTime());

        // 위 문제들을 해결하기 위해서 8 버전 부터 java.time 패키지를 제공함
